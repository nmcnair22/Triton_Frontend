...
<template>
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12">
            <div class="card">
                <div class="text-surface-900 dark:text-surface-0 text-xl font-semibold mb-4">Bill Import</div>
            </div>
        </div>
                    ...
                    <template #empty>
                        <div v-if="uploadFiles.length < 1" @click="onChooseUploadFiles" class="w-full py-4" :style="{ cursor: 'copy' }">
                            <div class="h-full flex flex-col justify-center items-center">
                                ...
                                <span class="font-bold text-surface-900 dark:text-surface-0 text-xl mb-4">Upload Bills</span>
