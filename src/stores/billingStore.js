  ...
  async function fetchDetailedInvoiceData(invoiceNumber) {
    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        detailedInvoiceError.value = response.data.message || 'No detailed invoice data found';
        return null;
      }
    } catch (err) {
  ...
  async function fetchDetailedPurchaseData(documentNo) {
    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        detailedPurchaseError.value = response.data.message || 'No detailed purchase data found';
        return null;
      }
    } catch (err) {
