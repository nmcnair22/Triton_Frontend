  ...
  async function fetchCustomers(params = {}) {
    ...
    try {
      ...
      if (response.data && response.data.data && response.data.data.value) {
        ...
        console.warn(
          "Unexpected response format or no customers in response:",
          response.data,
        );
        customers.value = [];
      }
  ...
  async function fetchActiveCustomers(params = {}) {
    ...
    try {
      ...
      if (response.data && response.data.data) {
        ...
        console.warn(
          "Unexpected response format or no active customers in response:",
          response.data,
        );
        customers.value = [];
      }
      ...
      if (err.response && err.response.status === 404) {
        console.warn(
          "Active customers endpoint not found, falling back to regular customers",
        );
